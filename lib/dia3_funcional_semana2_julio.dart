...
class Dia3FuncionalSemana2Julio extends StatelessWidget {
...
-Desde una plancha de manos, vamos a tocar con una mano nuestro hombro contrario, buscando que la cadera no se mueva durante el ejercicio.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Día 3 Semana 2 Julio', style: TextStyle(fontSize: 20 * 0.8)), // Reducido en 20%
        actions: [
          IconButton(
