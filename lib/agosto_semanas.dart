...
class AgostoSemanas extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> opciones = [
      {
        'title': 'Semana 1',
        'route': kRouteAgostoDiasSemana1,
      },
      {
        'title': 'Semana 2',
        'route': kRouteAgostoDiasSemana2,
      },
      {
        'title': 'Semana 3',
        'route': kRouteAgostoDiasSemana3,
      },
      {
        'title': 'Semana 4',
        'route': kRouteAgostoDiasSemana4,
      },
    ];
