...
class Dia1FuncionalSemana1Agosto extends StatelessWidget {
...
-Mismo trabajo de activación de cadera que el puente pero de forma unilateral. 
          ''',
          'youtubeUrl': 'https://www.youtube.com/watch?v=THFoBUhgm7M',
...
''',
          'youtubeUrl': 'https://www.youtube.com/watch?v=_C9CYvemYas',
...
*Si no disponemos de goma, podemos usar una toalla. 
          ''',
          'youtubeUrl': 'https://www.youtube.com/watch?v=OSrXRXD-WrQ',
...
-Buscamos la máxima flexión de cadera
          ''',
          'youtubeUrl': 'https://www.youtube.com/watch?v=5XiS10VCGxo',
...
-Dificultamos el ejercicio elevando la pierna estirada lo máximo posible 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Día 1 Semana 1'),
        actions: [
          IconButton(
