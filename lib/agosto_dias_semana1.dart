...
class AgostoDiasSemana1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> opciones = [
      {
        'title': 'Día 1',
        'route': kRouteAgostoDia1Semana1,
      },
      {
        'title': 'Día 2',
        'route': kRouteAgostoDia2Semana1,
      },
      {
        'title': 'Día 3',
        'route': kRouteAgostoDia3Semana1,
      },
    ];
